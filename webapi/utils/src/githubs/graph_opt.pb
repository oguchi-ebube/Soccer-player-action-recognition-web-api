...
<head>
                        ...
                        try {
                            ...
                            if (slot) {
                                slot.addService(googletag.pubads())
                                    .setTargeting('buildnumber', '121525')
    ...
    <script>
        try {
            ...
            gtag("js", new Date());
            gtag("config", "UA-829541-1", {"dimension1":"unregistered","dimension7":"legacy","dimension3":"other","dimension4":"1","dimension5":"pb","dimension8":"\/10\/20\/50\/100\/"});
        } catch(e) {}
    </script>
...
<div class="dl-btn-cont">
    ...
    <form         method="post"
        ...
        class="dl-btn-form"
        autocomplete="off">
        <input type="hidden" name="security" value="1588406800.05d3b9beedd8d0c70d752a000c5d494fce310482802ee1a0e115b36b43befaed"/>
                <div class="download_link" id="download_link">
                        ...
                        href="http://download2260.mediafire.com/nadvw0d114vg/qlzzr20mpocnpa3/graph_opt.pb">
                        Download (199.6MB)
                    </a>
                                <a class="starting" href="#"><span>Your download is starting...</span></a>
                <a class="retry" href="http://www.mediafire.com/download_repair.php?qkey=qlzzr20mpocnpa3&amp;dkey=nadvw0d114v&amp;template=1&amp;origin=click_button">
    ...
    <div id="subFooterWrap">
        <div id="subFooter" class="u-wrap">
            <ul class="subFooterLinks">
                <li id="copyrightInfo">&copy;2020 MediaFire<span> Build 121525</span></li>
...
(function() {
    ...
    var securityToken = "1588406800.05d3b9beedd8d0c70d752a000c5d494fce310482802ee1a0e115b36b43befaed";
    var loggedIn = false;
